...
LOCK TABLES `admin_login_table` WRITE;
/*!40000 ALTER TABLE `admin_login_table` DISABLE KEYS */;
INSERT INTO `admin_login_table` VALUES (1,'admin','abc123!@','Charles');
/*!40000 ALTER TABLE `admin_login_table` ENABLE KEYS */;
UNLOCK TABLES;
